...
with sync_playwright() as p:
    ...
    page.wait_for_selector('#poincare-plot .plot-container', timeout=60000)
    page.wait_for_selector('#ecg-plot-full .plot-container', timeout=60000)
    page.wait_for_selector('#ecg-plot-slider .plot-container', timeout=60000)
